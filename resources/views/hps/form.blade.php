...
<body>
    ...
    @if ($errors->has('manual_jenis_pekerjaan'))
    <div class="alert alert-danger">{{ $errors->first('manual_jenis_pekerjaan') }}</div>
@endif
        ...
        <tbody id="HpsTable">
            <tr>
                <td class="left-aligned">
                    <input type="text" inputmode="numeric" name="nomor[]" class="form-control" placeholder="No" style="width: 60px;" required>
                </td>
                <td style="width: 400px; word-wrap: break-word; white-space: normal;">
                    <select name="scope_pekerjaan" class="form-control rp-dropdown" required>
                ...
                <td>
                    <input type="text" inputmode="numeric" name="volume_angka" class="form-control" placeholder="Angka" style="width: 60px;" required>
                </td>
                <td>
                    <input type="text" name="volume_satuan" class="form-control" placeholder="Satuan" style="width: 70px;" required>
                </td>
                <td>
                    <input type="text" inputmode="numeric" id="total_harga_bahan" name="total_harga_bahan" class="form-control" readonly>
                </td>
                <td>
                    <input type="text" inputmode="numeric" id="total_harga_upah" name="total_harga_upah" class="form-control" readonly>
                </td>
                <td>
                    <input type="text" inputmode="numeric" id="total_harga_alat" name="total_harga_alat" class="form-control" readonly>
                </td>
                <td>
                    <input type="text" inputmode="numeric" id="pekerjaan" name="total_pekerjaan" class="form-control" required>
                </td>
                <td>
                    <input type="text" inputmode="numeric" id="bl_bahan" name="bl_bahan" class="form-control bl_bahan" required>
                </td>
                <td>
                    <input type="text" inputmode="numeric" id="bl_upah" name="bl_upah" class="form-control bl_upah" required>
                </td>
                <td>
                    <input type="text" inputmode="numeric" id="bl_alat" name="bl_alat" class="form-control bl_alat" required>
                </td>
                <td>
                    <input type="text" inputmode="numeric" id="jumlah" name="jumlah" class="form-control jumlah" required>
                </td>
            </tr>
        </tbody>
        <tfoot>
            <tr>
                ...
                <td><input type="text" id="totalHargaBahan" name="totalHargaBahan" readonly value="Rp 0,00"></td>
                <td><input type="text" id="totalHargaUpah" name="totalHargaUpah" readonly value="Rp 0,00"></td>
                <td><input type="text" id="totalHargaAlat" name="totalHargaAlat" readonly value="Rp 0,00"></td>
                <td><input type="text" id="totalBiaya" name="totalBiaya" readonly value="Rp 0,00"></td>
            </tr>
            <tr>
                <th colspan="8" class="right-aligned">PPN 11%:</th>
                <td><input type="text" id="totalHargaPpnBahan" name="totalHargaPpnBahan" readonly value="Rp 0,00"></td>
                <td><input type="text" id="totalHargaPpnUpah" name="totalHargaPpnUpah" readonly value="Rp 0,00"></td>
                <td><input type="text" id="totalHargaPpnAlat" name="totalHargaPpnAlat" readonly value="Rp 0,00"></td>
                <td><input type="text" id="totalBiayaPpn" name="totalBiayaPpn" readonly value="Rp 0,00"></td>
            </tr>
            <tr>
                <th colspan="8" class="right-aligned">Total Keseluruhan:</th>
                <td><input type="text" id="totalHargaKeseluruhanBahan" name="totalHargaKeseluruhanBahan" readonly value="Rp 0,00"></td>
                <td><input type="text" id="totalHargaKeseluruhanUpah" name="totalHargaKeseluruhanUpah" readonly value="Rp 0,00"></td>
                <td><input type="text" id="totalHargaKeseluruhanAlat" name="totalHargaKeseluruhanAlat" readonly value="Rp 0,00"></td>
                <td><input type="text" id="totalBiayaKeseluruhan" name="totalBiayaKeseluruhan" readonly value="Rp 0,00"></td>
            </tr>
            <tr>
                <th colspan="11" class="right-aligned">Dibulatkan:</th>
                <td><input type="text" id="totalBiayaDibulatkan" name="totalBiayaDibulatkan" readonly value="Rp 0,00"></td>
            </tr>
        </tfoot>
    </table>
    ...
    $('#addRow').on('click', function() {
        $('#HpsTable').append(`
            <tr>
                ...
                <td>
                    <input type="text" inputmode="numeric" name="volume_angka" class="form-control" placeholder="Angka" style="width: 60px;">
                </td>
                <td>
                    <input type="text" name="volume_satuan" class="form-control" placeholder="Satuan" style="width: 70px;">
                </td>
                <td>
