...
<head>
    ...
    <title>Basis Data Upah Tukang Bangunan</title>
...
<div class="container">
    ...
    <div class="d-flex gap-2 justify-content-center py-3">
        ...
        <a href="/upah-tukang-bangunan" class="btn btn-info rounded-pill px-3">Upah Tukang Bangunan</a>
    ...
    <div class="input-group">
        ...
        <button type="submit" class="btn btn-primary">Cari</button>
                    ...
                    <div class="card-body">
                        <a href="{{ route('upah-tukang-bangunan.create') }}" class="btn btn-md btn-success mb-3">Tambah Data Upah Tukang Bangunan</a>
                            ...
                            <table class="table table-bordered">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th scope="col">Proposional % Upah</th>
                                        <th scope="col">Upah Tahun 2023</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $post->proposional_persen_upah . '%' }}</td>
                                        <td>Rp. {{ number_format($post->upah_tahun_2023, 0, ',', '.') }}</td>
                                        <td class="text-center">
                                            <a href="{{ route('upah-tukang-bangunan.edit', $post->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                            <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('upah-tukang-bangunan.destroy', $post->id) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
