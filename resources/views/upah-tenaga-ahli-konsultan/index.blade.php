...
<head>
    ...
    <title>Basis Data Upah Tenaga Ahli Konstruksi</title>
...
<div class="container">
    ...
    <div class="d-flex gap-2 justify-content-center py-3">
        ...
        <a href="/upah-berdasarkan-penawaran" class="btn rounded-pill px-3">Upah Berdasarkan Penawaran</a>
        <a href="/upah-operator-alat" class="btn rounded-pill px-3">Upah Operator Alat</a>
        <a href="/upah-tenaga-ahli-konsultan" class="btn btn-info rounded-pill px-3">Upah Tenaga Ahli Konsultan</a>
    ...
    <div class="input-group">
        ...
        <button type="submit" class="btn btn-primary">Cari</button>
                ...
                <div class="card-body">
                    <a href="{{ route('upah-tenaga-ahli-konsultan.create') }}" class="btn btn-md btn-success mb-3">Tambah Data Upah Tenaga Ahli Konsultan</a>
                        ...
                        <table class="table table-bordered">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col">Harga Index Banten</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $post->satuan }}</td>
                                    <td>Rp. {{ number_format($post->harga_index_banten, 0, ',', '.') }}</td>
                                    <td>Rp. {{ number_format($post->harga_dasar, 0, ',', '.') }}</td>
                                    <td class="text-center">
                                        <a href="{{ route('upah-tenaga-ahli-konsultan.edit', $post->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('upah-tenaga-ahli-konsultan.destroy', $post->id) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
