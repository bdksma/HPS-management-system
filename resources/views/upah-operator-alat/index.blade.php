...
<head>
    ...
    <title>Basis Data Upah Operator Alat</title>
...
<div class="container">
    ...
    <div class="d-flex gap-2 justify-content-center py-3">
        ...
        <a href="/upah-operator-alat" class="btn btn-info rounded-pill px-3">Upah Operator Alat</a>
    ...
    <div class="input-group">
        ...
        <button type="submit" class="btn btn-primary">Cari</button>
                ...
                <div class="card-body">
                    <a href="{{ route('upah-operator-alat.create') }}" class="btn btn-md btn-success mb-3">Tambah Data Upah Operator Alat</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('upah-operator-alat.edit', $post->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                        <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('upah-operator-alat.destroy', $post->id) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
